...
namespace SDMS.AuthenticationApi.Helper
{
    public static class StaticDataHelper
    {
        ...
        {
            public const string app1 = "sdms  Web Application";
            public const string app2 = "sdms  Web Application";
        }
        public struct ApiNames
        {
            public const string GateWayApi = "sdms.gateway.api";
            public const string ContentManagementApi = "sdms.contentmanagement.api";
            //public const string BackOfficeWebAppe = "sdms.backoffice.web.app";
            //public const string DeliveryPartnerWebApp = "sdms.deliverypartner.web.app";
            //public const string VendorWebApp = "sdms.vendor.web.app";
        ...
        {
            public const string app1 = "sdms  api Application";
            public const string app2 = "sdms  api Application";
        }
        ...
        static StaticDataHelper()
        {
            ...
            new Client
            {
                ClientId = "sdms.app.extranet",
                ClientName = "sdms app Extranet Web Application",
            ...
            new Client
            {
                ClientId = "sdms.app.b2b",
                ClientName = "sdms app B2b Web Application",
                AllowedGrantTypes = GrantTypes.Implicit,
                AllowAccessTokensViaBrowser = true,
                RequireConsent = false,
                RedirectUris = {
                ...
                AllowedScopes = new List<string>
                    {
                        IdentityServerConstants.StandardScopes.OpenId,
                        IdentityServerConstants.StandardScopes.Profile,
                        "sdms.api.api.backoffice",
                        "sdms.api.api.extranet",
                        "sdms.api.api.usermanagement",
                        "sdms.api.api.gateway"
                  },
