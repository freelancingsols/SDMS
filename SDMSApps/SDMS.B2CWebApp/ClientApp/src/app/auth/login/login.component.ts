  ...
  async ngOnInit() {
    ...
    switch (actionPath) {
      case LoginActions.Login:
        ...
        break;
      case LoginActions.LoginCallback+'-'+CallbackActions.PopUp:
        await this.processLoginCallback(CallbackActions.PopUp);
        break;
      case LoginActions.LoginCallback+'-'+CallbackActions.Redirect:
        await this.processLoginCallback(CallbackActions.Redirect);
        break;    
      case LoginActions.LoginFailed:
        const message = this.activatedRoute.snapshot.queryParamMap.get(QueryParameterNames.Message);
        this.message.next(message || null);
        break;
