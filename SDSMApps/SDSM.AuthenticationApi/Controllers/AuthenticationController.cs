...
using SDSM.AuthenticationApi.Attributes;
using SDSM.AuthenticationApi.Extensions;
using SDSM.AuthenticationApi.Models;
using SDSM.AuthenticationApi.Models.Request;
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] Register request)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userCreateresult = _userManager.CreateAsync(user,request.Password).Result;
                //check user created 
