...
using SDSM.AuthenticationApi.Helper;
using SDSM.AuthenticationApi.Models;
using SDSM.AuthenticationApi.Contexts;
using Microsoft.AspNetCore.Authentication;

namespace SDSM.AuthenticationApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            opt.UseMySQL("Server=92.249.44.156;Database=u104383566_store;Uid=u104383566_store;Pwd=Magdum@123;");
